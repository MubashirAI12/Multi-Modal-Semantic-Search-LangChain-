...
from components.language_model import get_llm
from components.lcel_rag import semantic_search_rag
from config import *
...
def main():
    ...
    query= "what are  Modeling solar systems?"
    """
    ...
    """
    Inialize a large language model
    """
    llm = get_llm(model_name="phi3")
    answer = semantic_search_rag(query, vector_db, llm)
    print("done")
